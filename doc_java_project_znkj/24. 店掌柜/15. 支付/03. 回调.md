...
- [ ] 会员购卡
    - IZnDzgCardMemberService.insertByBo
- [x] 购卡回调
    - IZnDzgCardMemberService.purchaseCardCallBack
- [ ] 会员续费-支付前
    - IZnDzgCardMemberService.rechargeCard
- [x] 会员卡续费-支付后回调
    - IZnDzgCardMemberService.rechargeCardCallback
- [x] 会员购物抵扣卡余额或次卡，扣库存
    - IZnDzgCardMemberService.shoppingDeductionCard
- [ ] 商品退货
